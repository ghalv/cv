...
\item Interesser innen Computer Vision, Machine Learning og dataanalyse. Jobber mye med Python og behandling av datasett og databaser. Godt kjent med analyseverktøy som \href{https://tidyverse.org}{Tidyverse}, Pandas og TensorFlow.
...
\entry{2023--}
	{Dataingeniør}
	{Cerex}
	{Jobber med computer vision og machine learning.}

\entry{2023--}
	{Vikarlærer ved Sandnes Læringssenter}
	{Sandnes Kommune}
...
\entry{Prog.}
	{R (tidyverse), Python, bash/shell, SQL, C.}
	{}
	{}
