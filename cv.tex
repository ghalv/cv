...
\begin{itemize}
	...
	\item Inngående kjennskap til Python, R, git, shell og linux-systemer (Arch, Debian). Har også jobbet med React Native, node.js, filament/laravel, php, TensorFlow, docker, GraphQL, ansible og relasjonsdatabaser (SQL).
...
\entry{2025--}
	{Data Engineer}
	{Equinor}
  {OSDU-utvikler. Jobber med pipelines, horizons, &c.}
...
\entry{2023--}
	{Dataingeniør}
	{Cerex}
	{Ledet bl.a. app-utvikling for kunde i prosjekt som skal brukes i idrettshaller, og trente computer vision-modeller til edge devices.}
...
\entry{2022--2023}
	{Forskningsassistent}
	{\uis}
	{Laget programvare i python som ble utgangspunkt for android-app til datainnsamling. Håndterte også domener, og bidro med datainnsamling og kartlegging. }

\entry{2018--2022}
	{Instituttrådsmedlem ved \imf}
	{\uis}
	{Satt som valgt studentrepresentant i flere perioder. Så til at studentenes interesser ble ivaretatt.}
...
\entry{2018--2022}
 ...
 \entry{2017--2022}
	...
	{Studentorganisasjonen ved UiS, StOr}
 	{Nestleder i flere perioder. Utviklet foreningens nettside, og var med på utarbeidelse av kompendium i hhv. kalkulus og Newtonisk mekanikk.}
