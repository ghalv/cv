...
\begin{itemize}
	\item Bakgrunn innen matematikk/statistikk, men ser i grunnen på meg selv som en dataperson. Inngående kjennskap til Python, R, git, {\LaTeX}, shell, vim og linux-systemer (Arch, Debian). Har jobbet med teknologier som SQL, Docker, GraphQL og Ansible.
