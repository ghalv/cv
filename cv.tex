...
\begin{itemize}
\item Har bakgrunn innen matematikk/statistikk, men ser i grunnen på meg selv som en datatype. Interesser innen modellering og analyse. Inngående kjennskap til verktøy som R, git, {\LaTeX}, shell og vim. Har sertifikat fra DeepLearning.AI i Machine Learning og erfaring med python, SQL og teknologier som GraphQL, docker og ansible fra ulike prosjekter.
