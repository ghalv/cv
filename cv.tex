...
\begin{itemize}
	\item Bakgrunn innen matematikk/statistikk, men jobber som full stack-utvikler. Har utviklet React Native-apper med Firebase backend og node.js WebSocket.

	\item Inngående kjennskap til Python, R, git, shell og linux-systemer (Arch, Debian). Har også erfaring med teknologier som SQL, Docker, GraphQL og Ansible.
...
\entry{Prog.}
	{React Native/JavaScript, Python, R, bash/shell, SQL, C.}
	{}
	{}
...
Interesserer meg for friluftsliv, data, og historie. Leser en del, og går mye turer i skog og mark.
