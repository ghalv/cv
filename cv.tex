...
\begin{itemize}
\item Har bakgrunn innen matematikk/statistikk, men ser i grunnen på meg selv som en datatype. Interesser innen modellering og analyse. Inngående kjennskap til verktøy som R, git, {\LaTeX}, shell og vim. Har også erfaring med python, SQL og teknologier som GraphQL, docker og ansible fra ulike prosjekter.

\item Erfaring med behandling av store datasett vha. programmering og databaser. Godt kjent med analyseverktøyet \href{https://tidyverse.org}{tidyverse} og tilhørende arbeidsflyt med \textit{readr}, rensing av data med \textit{tidyr}, manipulering av data med \textit{dplyr} og grafisk fremstilling med \textit{ggplot2}.
...
\entry{Prog.}
	{R (tidyverse), bash/shell, Python, SQL, overfladisk kjennskap til C.}
	{}
	{}
